    ...
    constructor() {
        ...
        this.arrangements = {
            ...
            2: [
                ...
                { positions: [{x: 0, y: -25}, {x: 0, y: 25}] }
            ],
            3: [
                { positions: [{x: -30, y: 0}, {x: 0, y: 0}, {x: 30, y: 0}] },
                { positions: [{x: 0, y: -30}, {x: -20, y: 20}, {x: 20, y: 20}] },
                { positions: [{x: -25, y: -15}, {x: 25, y: -15}, {x: 0, y: 25}] }
            ],
            4: [
                { positions: [{x: -25, y: -25}, {x: 25, y: -25}, {x: -25, y: 25}, {x: 25, y: 25}] },
                { positions: [{x: -45, y: 0}, {x: -15, y: 0}, {x: 15, y: 0}, {x: 45, y: 0}] },
                { positions: [{x: -30, y: -15}, {x: 0, y: -15}, {x: 30, y: -15}, {x: 0, y: 25}] }
            ],
            5: [
                { positions: [{x: 0, y: -30}, {x: -25, y: 0}, {x: 25, y: 0}, {x: -25, y: 30}, {x: 25, y: 30}] },
                { positions: [{x: -30, y: -15}, {x: 0, y: -15}, {x: 30, y: -15}, {x: -15, y: 25}, {x: 15, y: 25}] },
                { positions: [{x: -50, y: 0}, {x: -25, y: 0}, {x: 0, y: 0}, {x: 25, y: 0}, {x: 50, y: 0}] }
            ],
            6: [
                { positions: [{x: -25, y: -40}, {x: 25, y: -40}, {x: -25, y: 0}, {x: 25, y: 0}, {x: -25, y: 40}, {x: 25, y: 40}] },
                { positions: [{x: -40, y: -20}, {x: 0, y: -20}, {x: 40, y: -20}, {x: -40, y: 20}, {x: 0, y: 20}, {x: 40, y: 20}] },
                { positions: [{x: -30, y: -30}, {x: 0, y: -30}, {x: 30, y: -30}, {x: -15, y: 15}, {x: 15, y: 15}, {x: 0, y: 45}] }
            ],
            7: [
                { positions: [{x: -40, y: -25}, {x: 0, y: -25}, {x: 40, y: -25}, {x: -40, y: 15}, {x: 0, y: 15}, {x: 40, y: 15}, {x: 0, y: 45}] },
                { positions: [{x: -30, y: -40}, {x: 0, y: -40}, {x: 30, y: -40}, {x: -15, y: 0}, {x: 15, y: 0}, {x: -30, y: 40}, {x: 30, y: 40}] },
                { positions: [{x: -50, y: 0}, {x: -30, y: 0}, {x: -10, y: 0}, {x: 10, y: 0}, {x: 30, y: 0}, {x: -20, y: 35}, {x: 20, y: 35}] }
            ],
            8: [
                { positions: [{x: -30, y: -40}, {x: 0, y: -40}, {x: 30, y: -40}, {x: -45, y: 0}, {x: 45, y: 0}, {x: -30, y: 40}, {x: 0, y: 40}, {x: 30, y: 40}] },
                { positions: [{x: -25, y: -50}, {x: 25, y: -50}, {x: -25, y: -15}, {x: 25, y: -15}, {x: -25, y: 15}, {x: 25, y: 15}, {x: -25, y: 50}, {x: 25, y: 50}] },
                { positions: [{x: -45, y: -25}, {x: -15, y: -25}, {x: 15, y: -25}, {x: 45, y: -25}, {x: -45, y: 25}, {x: -15, y: 25}, {x: 15, y: 25}, {x: 45, y: 25}] }
            ],
            9: [
                { positions: [{x: -30, y: -30}, {x: 0, y: -30}, {x: 30, y: -30}, {x: -30, y: 0}, {x: 0, y: 0}, {x: 30, y: 0}, {x: -30, y: 30}, {x: 0, y: 30}, {x: 30, y: 30}] },
                { positions: [{x: -40, y: -40}, {x: 0, y: -40}, {x: 40, y: -40}, {x: -40, y: 0}, {x: 0, y: 0}, {x: 40, y: 0}, {x: -20, y: 40}, {x: 0, y: 40}, {x: 20, y: 40}] },
                { positions: [{x: -50, y: -15}, {x: -25, y: -15}, {x: 0, y: -15}, {x: 25, y: -15}, {x: 50, y: -15}, {x: -30, y: 25}, {x: 0, y: 25}, {x: 30, y: 25}, {x: 0, y: 55}] }
            ],
            10: [
                { positions: [{x: -45, y: -45}, {x: -15, y: -45}, {x: 15, y: -45}, {x: 45, y: -45}, {x: -30, y: -15}, {x: 0, y: -15}, {x: 30, y: -15}, {x: -45, y: 15}, {x: 15, y: 15}, {x: 0, y: 45}] },
                { positions: [{x: -25, y: -60}, {x: 25, y: -60}, {x: -25, y: -30}, {x: 25, y: -30}, {x: -25, y: 0}, {x: 25, y: 0}, {x: -25, y: 30}, {x: 25, y: 30}, {x: -25, y: 60}, {x: 25, y: 60}] },
                { positions: [{x: -60, y: -20}, {x: -36, y: -20}, {x: -12, y: -20}, {x: 12, y: -20}, {x: 36, y: -20}, {x: -60, y: 20}, {x: -36, y: 20}, {x: -12, y: 20}, {x: 12, y: 20}, {x: 36, y: 20}] }
            ]
        };

class BlockCountingGame {
    constructor() {
        ...
        // Different arrangements for each number (blocks are 40px, so minimum 50px spacing)
        this.arrangements = {
            1: [
                { positions: [{x: 0, y: 0}] }
            ],
            ...
            3: [
                ...
                { positions: [{x: 0, y: -40}, {x: -35, y: 25}, {x: 35, y: 25}] },
                { positions: [{x: -30, y: -25}, {x: 30, y: -25}, {x: 0, y: 35}] }
            ],
            4: [
                { positions: [{x: -30, y: -30}, {x: 30, y: -30}, {x: -30, y: 30}, {x: 30, y: 30}] },
                { positions: [{x: -90, y: 0}, {x: -30, y: 0}, {x: 30, y: 0}, {x: 90, y: 0}] },
                { positions: [{x: -60, y: -25}, {x: 0, y: -25}, {x: 60, y: -25}, {x: 0, y: 35}] }
            ],
            5: [
                { positions: [{x: 0, y: -50}, {x: -35, y: -10}, {x: 35, y: -10}, {x: -35, y: 40}, {x: 35, y: 40}] },
                { positions: [{x: -60, y: -25}, {x: 0, y: -25}, {x: 60, y: -25}, {x: -30, y: 35}, {x: 30, y: 35}] },
            ...
            6: [
                ...
                { positions: [{x: -60, y: -40}, {x: 0, y: -40}, {x: 60, y: -40}, {x: -30, y: 20}, {x: 30, y: 20}, {x: 0, y: 70}] }
            ],
            7: [
                { positions: [{x: -60, y: -35}, {x: 0, y: -35}, {x: 60, y: -35}, {x: -60, y: 25}, {x: 0, y: 25}, {x: 60, y: 25}, {x: 0, y: 75}] },
                { positions: [{x: -60, y: -60}, {x: 0, y: -60}, {x: 60, y: -60}, {x: -30, y: 0}, {x: 30, y: 0}, {x: -60, y: 60}, {x: 60, y: 60}] },
                { positions: [{x: -120, y: 0}, {x: -60, y: 0}, {x: -20, y: 0}, {x: 20, y: 0}, {x: 60, y: 0}, {x: -40, y: 55}, {x: 40, y: 55}] }
            ],
            8: [
            ...
            9: [
                ...
                { positions: [{x: -80, y: -60}, {x: 0, y: -60}, {x: 80, y: -60}, {x: -80, y: 0}, {x: 0, y: 0}, {x: 80, y: 0}, {x: -40, y: 60}, {x: 0, y: 60}, {x: 40, y: 60}] },
                { positions: [{x: -120, y: -25}, {x: -60, y: -25}, {x: 0, y: -25}, {x: 60, y: -25}, {x: 120, y: -25}, {x: -60, y: 35}, {x: 0, y: 35}, {x: 60, y: 35}, {x: 0, y: 85}] }
            ],
            10: [
                { positions: [{x: -90, y: -70}, {x: -30, y: -70}, {x: 30, y: -70}, {x: 90, y: -70}, {x: -60, y: -10}, {x: 0, y: -10}, {x: 60, y: -10}, {x: -90, y: 50}, {x: 30, y: 50}, {x: 0, y: 100}] },
                { positions: [{x: -30, y: -120}, {x: 30, y: -120}, {x: -30, y: -60}, {x: 30, y: -60}, {x: -30, y: 0}, {x: 30, y: 0}, {x: -30, y: 60}, {x: 30, y: 60}, {x: -30, y: 120}, {x: 30, y: 120}] },
                { positions: [{x: -120, y: -30}, {x: -72, y: -30}, {x: -24, y: -30}, {x: 24, y: -30}, {x: 72, y: -30}, {x: -120, y: 30}, {x: -72, y: 30}, {x: -24, y: 30}, {x: 24, y: 30}, {x: 72, y: 30}] }
            ]
        };

class MysteryNumberGameV4 {
    ...
    // ---- Problem Generation (same as v1/v2/v3) ----
    ...
    showPicker() {
        ...
        if (this.pickerMode === 'circle') {
            ...
            if (this.activeSlot === 'operator') {
                ...
                // Number slots: show the two numbers (result and operand)
    ...
    onPickerSelectSlot(value) {
        ...
        if (this.builderSlots[this.activeSlot] === value) {
            // Tapping same value again clears it
